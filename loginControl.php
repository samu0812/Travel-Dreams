...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $consulta = "SELECT p.id_usuario, p.correo, uc.password FROM personas AS p INNER JOIN usuario_cliente AS uc ON p.id_usuario = uc.personas_id_usuario where p.correo='$correo' and uc.password = '$password'";
